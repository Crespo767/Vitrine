    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-secondary">
        ...
        <button
          ...
          className="absolute right-2 top-2 rounded-full bg-card/80 p-1.5 backdrop-blur transition-colors hover:bg-card"
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-3">
        ...
        <div className="mt-2 flex gap-2">
          ...
          <Button size="sm" className="flex-1 gap-1 bg-accent text-accent-foreground text-xs hover:bg-accent/90">
